...
class MyUser(AbstractBaseUser):
    ...
    name = models.CharField(max_length=40, verbose_name="Istifadəçi adi", blank=True, null=True)
    surname = models.CharField(max_length=40, verbose_name="Istifadəçi soyadi", blank=True, null=True)
